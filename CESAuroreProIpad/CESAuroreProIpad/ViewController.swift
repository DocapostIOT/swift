    ...
    func itemDidFinishPlaying(){
        ...
        if (auto){
          ...
          //  })
            ...
            let str = String(self.vid);
            if(str != "113" && str != "203" && str != "307" && str != "404" && str != "505" && str != "604" && str != "705"){
                self.playVid(name: str);
            }
    ...
    */
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager,
        ...
        for req in requests{
            ...
            NSLog(str);
            if (str == "100" || str == "200" || str == "300" || str == "400" || str == "500" || str == "600" || str == "700"){
                auto = false;
            ...
            else if(str == "112" || str == "202" || str == "306" || str == "403" || str == "504" || str == "603" || str == "704"){
                auto = false;
                self.vid = Int(str)! + 1
                playerViewController?.player!.play()
                var message = 0;
    ...
    func peripheralManagerDidUpdateState(_ peripheral: CBPeripheralManager){
        if(peripheral.state == .poweredOn){
            service1 = CBMutableService.init(type: CBUUID.init(string:"A6CD6F10-8710-4695-A915-6DF8727E0F54"), primary: true);
            ...
            peripheralManager?.startAdvertising([CBAdvertisementDataLocalNameKey : "IpadDemoCES", CBAdvertisementDataServiceUUIDsKey:[CBUUID.init(string: "A6CD6F10-8710-4695-A915-6DF8727E0F54")]]);
